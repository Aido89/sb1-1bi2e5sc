...
function App() {
  ...
  const MAX_PARTICIPANTS = 465;
  const targetDate = new Date('2025-05-04T00:00:00');

  // Load participant count from Supabase
  React.useEffect(() => {
    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-2 md:space-x-4">
              ...
              />
              <h1 className="text-xl md:text-4xl font-squid">BAYS GAME</h1>
            </div>
          ...
          <div className="space-y-6 md:space-y-8">
            <div className="bg-gray-900 p-4 md:p-6 rounded-lg border border-pink-600 shadow-lg">
              ...
              <p className="text-gray-300 mb-4 md:mb-6 text-sm md:text-base">
                Добро пожаловать в Bays Game, вдохновленную популярным сериалом "Игра в кальмара". 
              ...
              <div className="mt-4 md:mt-6">
                ...
                <ul className="list-disc list-inside text-gray-300 space-y-1 text-sm md:text-base">
                  ...
                  <li>Только 465 участников будут допущены</li>
                  <li>Все участники получат инструкции по email</li>
              ...
              <div className="fixed inset-0 flex items-center justify-center bg-black/70 z-50 p-4">
                <div className="bg-gray-800 p-4 md:p-6 rounded-lg border border-green-500 max-w-md mx-auto">
                  ...
                  <p className="text-gray-300 text-center mt-2 text-sm md:text-base">
                    Вы успешно зарегистрированы на Bays Game. Ожидайте дальнейших инструкций на указанный email.
                  </p>
                </div>
              </div>
            )}
      ...
      <footer className="bg-gray-900 py-4 md:py-6 mt-8 md:mt-12">
        <div className="container mx-auto px-4 text-center text-gray-400">
          ...
          <p className="text-sm md:text-base font-squid">© 2025 Bays Game. Все права защищены.</p>
